...
class CinematographerService(ICinematographer):
    ...
    def _generate_keyframe_a(self, plan: VideoPlan, reference_pose_index: int) -> tuple[str, types.GenerateContentResponse]:
        """Generate the first keyframe (Master shot)."""
    ...
    def _generate_sequential_keyframes(self, plan: VideoPlan, variety_instruction: str, previous_response_parts: list) -> Dict[str, str]:
    ...
    def generate_assets(self, plan: VideoPlan, output_dir: str = None, scene_variety: int = None, reference_pose_index: int = 0) -> Dict[str, str]:
        ...
        try:
            ...
            sequential_assets = self._generate_sequential_keyframes(plan, variety_instruction, response_a.parts)
